"""
Momentum Optimizer (Classical and Nesterov)

Mathematical Background:
========================
Momentum is an accelerated gradient-based optimization technique that accumulates a velocity vector in directions of persistent reduction in the objective function. This helps smooth out oscillations and can significantly speed up convergence, especially on ravine-shaped surfaces.
...
Where:
- x_k: current point
- v_k: velocity (momentum)
- α: learning rate
- β: momentum parameter (typically 0.9)

Convergence:
- Faster than vanilla GD on ill-conditioned problems
- NAG can provide even faster convergence and better theoretical guarantees
