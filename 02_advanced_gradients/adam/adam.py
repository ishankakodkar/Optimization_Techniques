...
class Adam:
    ...
    def minimize(self, objective: Callable, initial_point: np.ndarray, gradient: Optional[Callable] = None) -> Tuple[np.ndarray, dict]:
        ...
        if self.verbose:
            ...
            print(f"Learning rate: {self.learning_rate}, Beta1: {self.beta1}, Beta2: {self.beta2}, Epsilon: {self.epsilon}")
        ...
        for iteration in range(1, self.max_iterations + 1):
            ...
            step_size = self.learning_rate / (np.sqrt(v_hat) + self.epsilon)
